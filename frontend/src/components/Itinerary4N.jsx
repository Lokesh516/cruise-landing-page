...
export default function Itinerary4N() {
  const itinerary = [
    { day: "Day 1", visit: "Aswan", overnight: "Cruise" },
    { day: "Day 2", visit: "Kom Ombo & Edfu", overnight: "Edfu" },
    { day: "Day 3", visit: "Esna", overnight: "Luxor" },
    { day: "Day 4", visit: "East Bank Luxor", overnight: "Luxor" },
    { day: "Day 5", visit: "Checkout", overnight: "West Bank Visit" },
  ];
    ...
    <section className="bg-[#fdf8f3] py-12 px-6">
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md border border-[#e8d8c3] p-6">
        ...
        <div className="overflow-x-auto">
          <div className="flex gap-6 min-w-[800px] px-2 sm:px-4">
